...
abstract public class SelectKeyCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        CheatSheet.setup(holder.creation,getContentDescription(holder.creation));
        CheatSheet.setup(holder.statusIcon,getContentDescription(holder.statusIcon));
        CheatSheet.setup(holder.selected,getContentDescription(holder.selected));
        view.setTag(holder);
        return view;
    }
}
