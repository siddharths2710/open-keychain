...
public class UserIdsAddedAdapter extends ArrayAdapter<String> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            CheatSheet.setup(holder.vName,getContentDescription(holder.vName));
            CheatSheet.setup(holder.vAddress,getContentDescription(holder.vAddress));
            CheatSheet.setup(holder.vComment,getContentDescription(holder.vComment));
            CheatSheet.setup(holder.vDelete,getContentDescription(holder.vDelete));
            // not used:
